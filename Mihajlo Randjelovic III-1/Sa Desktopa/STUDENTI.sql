...
ALTER TABLE ispit
ADD CONSTRAINT fkIspRok FOREIGN KEY (OZNAKA_ROKA) REFERENCES ispitni_rok(OZNAKA_ROKA);

INSERT INTO dosije VALUES
('111', 'Darko', 'Antić', '2000', 'Smederevo'),
('222', 'Sanja', 'Pavlović', '2000', 'Smederevo'),
('333', 'Vukašin', 'Bošković', '2001', 'Subotica'),
('444', 'Dejan', 'Nikolić', '2002', 'Niš'),
('555', 'Danijela', 'Antić', '2001', 'Negotin'),
('666', 'Mihajlo', 'Janković', '2000', 'Smederevo')
...
(06, 'TEK', 'TEORIJA ELEKTRIČNIH KOLA', 12);
